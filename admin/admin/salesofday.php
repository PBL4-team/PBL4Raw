  ...
  <div class="container-fluid">
    ...
    <div class="col-md-14">
      ...
      <nav aria-label="Page navigation example">
        <ul class="pagination">
          <li class="page-item">
            <a class="page-link" href="salesofday.php?page=<?php echo $prevpage; ?>" aria-label="Previous">
          ...
          for ($b = 1; $b <= $a; $b++) {
            if ($b == $page) {
          ?>
              <li class="page-item active"><a class="page-link" href="salesofday.php?page=<?php echo $b; ?>"><?php echo $b . " "; ?></a></li>
            <?php
            } else {
            ?>
              <li class="page-item"><a class="page-link" href="salesofday.php?page=<?php echo $b; ?>"><?php echo $b . " "; ?></a></li>
          <?php
            }
          }
          ?>
          <li class="page-item">
            <a class="page-link" href="salesofday.php?page=<?php echo $nextpage; ?>" aria-label="Next">
