...
$result = mysqli_query($con, "select product_title, product_desc, product_price, product_cat, product_brand from products where product_id = '$pro_id'") or die("query 1 incorrect.....");
list($product_title, $product_desc, $product_price, $product_cat, $product_brand) = mysqli_fetch_array($result);
