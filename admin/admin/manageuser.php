...
if (isset($_GET['action']) && $_GET['action'] != "" && $_GET['action'] == 'delete') {
  ...
  $result = mysqli_query($con, "select order_id from orders_info where user_id='$user_id'") or die("query 2 incorrect.......");

  while (list($order_id) = mysqli_fetch_array($result)) {
    mysqli_query($con, "update orders_info set user_id = -1 where order_id='$order_id'") or die("query is incorrect...");
  }
            ...
            <table class="table tablesorter table-hover" id="">
              ...
              <tbody>
                ...
                for ($i = $start; $i < $end; $i++) {
                  ...
                  //       <a class='btn btn-success' style='background-color:green;' href='edituser.php?user_id=$user_id&action=delete'>Edit<div class='ripple-container'></div></a>
                  //       </td>";
                  echo "<td>
